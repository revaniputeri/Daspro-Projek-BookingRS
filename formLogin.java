...
public class formLogin {
    ...
    static char statusbpjs,
            pembayaran,
            status;
    static int transaksiPasien2[][] = new int[3][20],
    ...
    static void login() {
        ...
        if ((inputUsername.equals(usernameadmn[0]) && inputPass.equals(pass[0]))
            ...
            while (!isNewData) {
                displayMenu(inputUsername);
                isLoggedin = true;
                System.out.print("Pilih Menu (1 - 6): ");
                adminChoice = input.nextInt();

                if (adminChoice == 1) {
                    transaksiBaru(transaksiPasien, transaksiPasien2, grandTotal, adminChoice, adminChoice, status,
                            inputUsername, registrasiPasien, adminChoice, statusbpjs, adminChoice, pembayaran);
                    ;
    ...
    static void displayMenu(String inputUsername) {
        System.out.println("==========================================================================");
    ...
    static void transaksiBaru(String[][] transaksiPasien, int[][] transaksiPasien2, int[] grandTotal,
            int jumlahTransaksi, int jumlahPasien, char status, String inputUsername, String registrasiPasien[][],
            int i, char statusbpjs, int potonganBpjs, char pembayaran) {
        for (i = 0; i < transaksiPasien.length; i++) {
            System.out.println(
                    "==========================================================================");
            ...
            if (status == '0') {
                ...
                registrasiPasien(registrasiPasien, transaksiPasien, jumlahTransaksi);
